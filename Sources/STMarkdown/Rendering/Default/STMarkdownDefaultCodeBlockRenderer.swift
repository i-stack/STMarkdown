...
public struct STMarkdownDefaultCodeBlockRenderer: STMarkdownCodeBlockRendering {
    ...
    public func renderCodeBlock(language: String?, code: String, style: STMarkdownStyle) -> NSAttributedString? {
        ...
        let headerAttributes: [NSAttributedString.Key: Any] = [
            .font: UIFont.st_preferredMonospacedFont(ofSize: max(style.font.pointSize - 2, 12), weight: .semibold),
        ...
        let bodyAttributes: [NSAttributedString.Key: Any] = [
            .font: UIFont.st_preferredMonospacedFont(ofSize: max(style.font.pointSize - 1, 12), weight: .regular),
